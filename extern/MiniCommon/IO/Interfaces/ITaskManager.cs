...
public interface ITaskManager
{
    ...
    /// </summary>
    public static abstract Task Run(Func<Task> function);

    /// <summary>
    /// Executes a function asynchronously with a return value and cancellation token.
    /// </summary>
    public static abstract Task<TResult> Run<TResult>(
    ...
    /// </summary>
    public static abstract Task<TResult> Run<TResult>(Func<Task<TResult>> function);
    ...
    /// </summary>
    public static abstract Task<TResult> Run<TResult>(Func<TResult> function);

    /// <summary>
    /// Executes a function asynchronously with no return value and cancellation token.
    /// </summary>
    public static abstract Task Run(Func<Task> function, CancellationToken cancellationToken);

    /// <summary>
    /// Executes an action asynchronously with a cancellation token.
    /// </summary>
    public static abstract Task Run(Action action, CancellationToken cancellationToken);

    /// <summary>
    /// Executes an action asynchronously with no return value.
    /// </summary>
    public static abstract Task Run(Action action);
}
